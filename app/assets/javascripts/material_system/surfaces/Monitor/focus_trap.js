/**
 * Minimal focus trap for anchored overlays (regex builder popover, command palette).
 * Framework-neutral so any of this surface's overlay components can reuse the same
