...
export const DESIGN_ROUTE_INTEGRATION_CONTRACTS = Object.freeze([
  ...
  Object.freeze({ id: 'surface.pipelines', reference: 'design/Pipelines.dc.html', status: 'wired', route: '/:namespace/:project/-/pipelines', entrypoint: 'app/assets/javascripts/pages/projects/pipelines/index/index.js', initializer: 'mountPipelines', host: '#js-material-pipelines' }),
  ...
  Object.freeze({ id: 'surface.repository', reference: 'design/Repository.dc.html', status: 'route-contract-pending', limitation: 'The repository bundle mounts only when a server view supplies an adapter and #js-material-repository-app host; neither contract is currently present on project repository views.' }),
