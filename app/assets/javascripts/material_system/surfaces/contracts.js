...
export const DESIGN_ROUTE_INTEGRATION_CONTRACTS = Object.freeze([
  ...
  unresolved('surface.analyze', 'design/Analyze.dc.html', 'preserved-host', 'The authenticated Apollo router owns the host; no production page entrypoint imports mountAnalyzeSurface.', { route: '/explore/analytics_dashboards', view: 'app/assets/javascripts/material_system/mounts.js', host: '#js-explore-analytics-dashboards' }),
  ...
  unresolved('surface.settings', 'design/Settings.dc.html', 'source-registration', 'The initializer exists, but current settings page entries do not import it.', { entrypoint: 'app/assets/javascripts/material_system/surfaces/Settings/index.js', initializer: 'mountProjectSettings', host: '[data-material-project-settings]' }),
  unresolved('surface.shell-a', 'design/Shell A.dc.html', 'source-registration', 'The component is registered for reuse but no production bootstrap mounts it.', { entrypoint: 'app/assets/javascripts/material_system/surfaces/ShellA/ShellA.vue' }),
