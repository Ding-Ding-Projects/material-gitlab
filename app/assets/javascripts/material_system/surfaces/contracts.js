...
export const DESIGN_ROUTE_INTEGRATION_CONTRACTS = Object.freeze([
  ...
  Object.freeze({ id: 'surface.build', reference: 'design/Build.dc.html', status: 'route-contract-pending', limitation: 'No Rails host and page entrypoint are bound to this standalone design surface.' }),
