<template>
  <div
    :id="`am-anchor-${skill.id}`"
    class="am-card am-skill-card"
    :data-am-anchor="skill.id"
    tabindex="-1"
  >
    <div class="am-skill-card__head">
      ...
      <span
        class="am-badge am-badge--small"
        :class="`am-badge--${skill.status === 'installed' ? 'in-sync' : 'neutral'}`"
      >
        {{ skill.status }}
      </span>
    </div>
