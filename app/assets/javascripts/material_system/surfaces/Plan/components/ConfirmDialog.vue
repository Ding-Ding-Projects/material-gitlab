<template>
  <div class="gl-mds-confirm-layer" @click.self="$emit('cancel')">
    <div
      ...
      role="alertdialog"
      aria-modal="true"
      aria-labelledby="gl-mds-plan-confirm-title"
      aria-describedby="gl-mds-plan-confirm-message"
      tabindex="-1"
      @keydown.esc="$emit('cancel')"
      @keydown.tab="trapFocus"
    >
      <h2 id="gl-mds-plan-confirm-title" class="gl-mds-confirm__heading">{{ title }}</h2>
      <p id="gl-mds-plan-confirm-message" class="gl-mds-confirm__message">{{ message }}</p>
