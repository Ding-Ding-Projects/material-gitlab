...
module EE
  module GroupPolicy
    ...
    prepended do
      ...
      rule { ~can_manage_ldap }.prevent :admin_ldap_group_links
      ...
      condition(:duo_governance_enabled) do
      ...
      # tool rules: owners/maintainers hold it via their role, but it is withheld when Duo features
      ...
      # transitions past `trial_eligible`
