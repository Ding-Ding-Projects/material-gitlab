    ...
    <gl-tab title="Issues">
      ...
      <div class="card gl-flex gl-flex-row gl-flex-wrap gl-bg-subtle gl-px-4">
        ...
        <div v-if="shouldShowFilterByLabel" class="gl-my-3 gl-flex gl-basis-1/2 gl-items-center">
          ...
          <!-- eslint-disable vue/v-on-event-hyphenation -- labels_select_root is a shared component that emits the camelCase `updateSelectedLabels` event -->
          <labels-select
