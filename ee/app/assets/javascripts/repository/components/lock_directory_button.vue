<script>
import { GlButton, GlButtonGroup, GlTooltip, GlModal, GlModalDirective } from '@gitlab/ui';
...
<template>
  <gl-button-group v-if="showLockButton" ref="buttonWrapper" class="gl-w-full @md/panel:gl-w-auto">
