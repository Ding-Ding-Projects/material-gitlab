...
import EventActionsConfiguration from './event_configurations/event_actions_configuration.vue';
import PipelineEventsConfiguration from './event_configurations/pipeline_events_configuration.vue';
import ScheduleEventsConfiguration from './event_configurations/schedule_events_configuration.vue';
...
const EVENT_CONFIGURATIONS = {
  ...
  [FLOW_TRIGGER_TYPE_MERGE_REQUEST.value]: {
    ...
    props: {
      ...
      cardTitle: s__('DuoAgentsPlatform|Merge request events configuration'),
  ...
  [FLOW_TRIGGER_TYPE_WORK_ITEM.value]: {
    ...
    props: {
      ...
      cardTitle: s__('DuoAgentsPlatform|Work item events configuration'),
        ...
        description: item.description
          ? sprintf(
              typeof item.description === 'function'
                ? item.description(this.glFeatures)
                : item.description,
