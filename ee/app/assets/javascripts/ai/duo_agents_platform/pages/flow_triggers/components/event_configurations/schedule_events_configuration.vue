<script>
import { GlCard, GlCollapsibleListbox, GlFormGroup, GlFormInput } from '@gitlab/ui';
...
<template>
  <gl-card>
    ...
    <gl-form-group
      ...
      :class="{ 'gl-mb-0': !hasContextualFields }"
    >
    ...
    <gl-form-group v-if="showDayOfWeek" :label="s__('DuoAgentsPlatform|Run on')" class="gl-mb-5">
    ...
    <gl-form-group v-if="showDayOfMonth" :label="s__('DuoAgentsPlatform|Run on')" class="gl-mb-5">
      <div class="gl-flex gl-items-center gl-gap-3">
        <gl-collapsible-listbox
