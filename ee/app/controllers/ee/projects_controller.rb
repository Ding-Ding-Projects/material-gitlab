  ...
  module ProjectsController
    ...
    prepended do
      ...
      before_action do
        ...
        push_frontend_feature_flag(:enable_dependency_bump_breaking_changes, @project&.root_ancestor, type: :beta)
      end
    ...
    def sec_ai_workflow_setting_in_params?
      setting_attrs = params.dig(:project, :project_setting_attributes)
    ...
    def duo_feature_attributes
      ...
      if ::Feature.enabled?(:enable_dependency_bump_breaking_changes, project&.root_ancestor)
