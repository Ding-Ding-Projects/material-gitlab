...
describe('ListWrapper', () => {
  ...
  it('links each policy name to its edit path', () => {
    ...
    expect(links.map((link) => link.attributes('href'))).toEqual(
      mockPolicies.map((policy) => policy.editPath),
    );
  });
  ...
  describe('empty state', () => {
    ...
    it('does not render the placeholder when the fetch failed', () => {
