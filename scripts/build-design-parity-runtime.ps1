...
function Get-RecipeHash {
  ...
  $recipeFiles = @('qa/gdk/Dockerfile.gdk', 'qa/gdk/Dockerfile.gdk.dockerignore', 'qa/gdk/.tool-versions', 'qa/gdk/gdk.yml', 'qa/gdk/normalize-executable-shebangs.rb', 'qa/gdk/entrypoint', 'qa/gdk/pre-receive')
