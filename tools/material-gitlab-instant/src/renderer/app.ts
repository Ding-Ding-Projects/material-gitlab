...
function render(): void {
  ...
  root.querySelector<HTMLButtonElement>('#save')?.addEventListener('click', () => void saveConfig());
  root.querySelector<HTMLButtonElement>('#verify')?.addEventListener('click', () => void verify());
  root.querySelector<HTMLButtonElement>('#open')?.addEventListener('click', () => void openVerified());
}
